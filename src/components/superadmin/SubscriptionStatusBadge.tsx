...
const MAP: Record<string, { label: string; cls: string }> = {
  ...
  past_due: { label: "Inadimplente", cls: "bg-amber-500/10 text-amber-600 border-amber-500/20" },
  canceled: { label: "Cancelada",   cls: "bg-muted text-muted-foreground border-border" },
  paused:   { label: "Pausada",     cls: "bg-zinc-500/10 text-zinc-600 border-zinc-500/20" },
};
