...
export async function renderExameComLayout(
  ...
  const tituloHtml = `<div class="exame-header-band" style="position:relative;width:100%;box-sizing:border-box;margin:0 0 12px 0;page-break-after:avoid;break-after:avoid;page-break-inside:avoid;break-inside:avoid;font-family:Helvetica,Arial,sans-serif;background-color:#f7f8f9 !important;-webkit-print-color-adjust:exact !important;print-color-adjust:exact !important;color-adjust:exact !important;padding:0 calc(${_dataColetaRightMm}mm + 62mm) 0 10px;text-align:left;font-size:10pt;font-weight:700;color:#000;text-transform:uppercase;letter-spacing:0.2px;line-height:20px;height:20px;"><span style="position:absolute;left:10px;top:50%;transform:translateY(-50%);line-height:1.2;">${exameNome}</span><span style="position:absolute;right:${_dataColetaRightMm}mm;top:50%;transform:translateY(-50%);font-size:6pt;font-weight:700;color:#000;font-family:Helvetica,Arial,sans-serif;white-space:nowrap;text-transform:none;letter-spacing:0;line-height:1.4;">${dataColetaLabel || ""}</span></div>`;
