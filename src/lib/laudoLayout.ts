...
export async function renderExameComLayout(
  ...
  const tituloHtml = `<table class="exame-header-band" cellpadding="0" cellspacing="0" style="width:100%;border-collapse:collapse;background-color:#f7f8f9 !important;margin:0 0 12px 0;page-break-after:avoid;break-after:avoid;page-break-inside:avoid;break-inside:avoid;-webkit-print-color-adjust:exact !important;print-color-adjust:exact !important;color-adjust:exact !important;font-family:Helvetica,Arial,sans-serif;"><tr><td style="padding:8px 10px;vertical-align:middle;text-align:left;font-size:10pt;font-weight:700;color:#000;text-transform:uppercase;letter-spacing:0.2px;line-height:1;">${exameNome}</td><td style="padding:8px 10px;vertical-align:middle;text-align:right;font-size:8pt;font-weight:700;color:#000;white-space:nowrap;line-height:1;">${dataColetaLabel ?? ""}</td></tr></table>`;
