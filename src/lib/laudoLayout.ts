...
export async function renderExameComLayout(
  ...
  const tituloHtml = `<div style="display:flex;align-items:flex-end;justify-content:space-between;gap:12px;font-family:Helvetica,Arial,sans-serif;margin-top:0;margin-bottom:0;padding-bottom:16px;"><div style="font-size:10pt;font-weight:700;color:#000000;white-space:normal;">${exameNome}</div>${dataColetaHtml}</div>`;
