...
import {
  ArrowDownCircle, ArrowUpCircle, BookOpen, Banknote, CreditCard, QrCode, Clock, LayoutDashboard,
} from "lucide-react";
import type { MockAtendimento } from "@/data/types";

export type TabType = "painel" | "entrada" | "a_receber" | "saida" | "caixa" | "integracoes";
