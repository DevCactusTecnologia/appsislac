      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-5 sm:py-6 animate-fade-in">
        ...
        <div className="hidden lg:flex flex-row gap-0 min-h-[calc(100vh-140px)] bg-card rounded-2xl overflow-hidden border border-border/60 shadow-[0_1px_2px_rgba(0,0,0,0.04)]">
          ...
          <ExameSidebar
            ...
            progresso={progresso}
            goToNextPendente={goToNextPendente}
            searchQuery={searchQuery}
            setSearchQuery={setSearchQuery}
            statusFilter={statusFilter}
            setStatusFilter={setStatusFilter}
            filteredExames={filteredExames}
            isHydrating={isHydrating}
            selectedExameId={selectedExameId}
            setSelectedExameId={setSelectedExameId}
            dbIdMap={dbIdMap}
            dbRows={dbRows}
            retificados={retificados}
            isExameLiberado={isExameLiberado}
            isExameTerceirizadaById={isExameTerceirizadaById}
            getLabNome={getLabNome}
            getMnemonico={getMnemonico}
            onImprimirExame={handleImprimir}
          />
