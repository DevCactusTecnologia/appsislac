    ...
    return (
      ...
      >
        <SelectTrigger
          ...
          className={`h-10 w-full rounded-lg bg-background font-semibold text-foreground justify-between text-left border-2 outline-none focus:outline-none focus-visible:outline-none focus:ring-2 focus:ring-offset-0 focus:ring-primary focus:border-primary focus:bg-primary/10 focus:shadow-md transition-all ${
            isCritico
