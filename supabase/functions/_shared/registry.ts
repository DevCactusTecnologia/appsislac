...
export const CAPABILITIES: CapabilityMeta[] = [
  ...
  {
    id: "paciente.exames",
    title: "Exames por paciente",
    description: "Lista os exames realizados por um paciente (por nome, CPF ou ID).",
    permission: "visualizar_pacientes",
    category: "paciente",
    visibility: "always",
    priority: 25,
    ...
    icon: "FileText",
    color: "primary",
    actions: [{ id: "paciente.exames", tool: "paciente_exames" }],
    promptTemplate: "Quais exames o paciente ",
  },
  {
  ...
  },
  {
    ...
    description: "Abre a tela de resultado do paciente (último atendimento ou exame indicado).",
    ...
    icon: "FileSearch",
    color: "primary",
    actions: [{ id: "resultado.open", tool: "resultado_open" }],
    promptTemplate: "Abrir resultado do paciente ",
  },
  {
    id: "resultado.set_valor",
    title: "Inserir valor de exame",
    description: "Insere/atualiza o valor de um parâmetro no resultado de um exame do paciente.",
    permission: "liberar_resultado",
    category: "resultados",
    visibility: "always",
    priority: 41,
