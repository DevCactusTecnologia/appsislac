...
BEGIN
  ...
  -- Pipeline operacional (status atuais, snapshot do momento)
  SELECT
  ...
  -- "Liberados hoje" = atendimentos com pelo menos 1 exame liberado HOJE
  -- (data_liberacao do exame, não data de criação do atendimento).
